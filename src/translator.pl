...
translate_expr([H0|T0], Goals, Out) :-
        ...
        ; HV == hyperpose -> append(GsH, [unsupported_feature(hyperpose, hyperpose, 'hyperpose is not supported in browser runtime v1.')], Goals)
        ; HV == with_mutex -> append(GsH, [unsupported_feature(with_mutex, with_mutex, 'with_mutex is not supported in browser runtime v1.')], Goals)
        ; HV == transaction -> append(GsH, [unsupported_feature(transaction, transaction, 'transaction is not supported in browser runtime v1.')], Goals)
